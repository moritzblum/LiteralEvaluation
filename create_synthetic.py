...
CLASS_MAPPING_FILE = 'FB15k-237_class_mapping.csv'
...
if __name__ == '__main__':
    ...
    human_uris = [x for x in class_mapping_df[class_mapping_df["class_label"] == "human"][
    ...
    neg_samples = class_mapping_df[class_mapping_df["class_label"] != "human"][

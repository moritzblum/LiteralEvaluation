...
sys.path.insert(0, '/homes/mblum/pytorch_geometric')
sys.path.insert(0, '/Users/moritzblum/Projects/pytorch_geometric')
...
"""
TransE (paper)
python -u pyg_transea.py --model transea --dataset FB15k-237 --alpha 0 --lr 0.01 --hidden 50

TransEA (paper)
python -u examples/pyg_transea.py --model transea --dataset FB15k-237 --alpha 0.3 --lr 0.001 --hidden 100 --features numerical_literals.npy --saved_models_path="/homes/mblum/LiteralEvaluation/saved_models" > ~/LiteralEvaluation/results/slurm_transea_fb15k-237_org.txt
python -u examples/pyg_transea.py --model transea --dataset LitWD48K --alpha 0.3 --lr 0.001 --hidden 100 --features numerical_literals_decimal.npy --saved_models_path="/homes/mblum/LiteralEvaluation/saved_models" > ~/LiteralEvaluation/results/slurm_transea_litwd48k_org.txt
python -u examples/pyg_transea.py --model transea --dataset YAGO3-10 --alpha 0.3 --lr 0.001 --hidden 100 --features numerical_literals.npy --saved_models_path="/homes/mblum/LiteralEvaluation/saved_models" > ~/LiteralEvaluation/results/slurm_transea_yago3-10_org.txt
python -u examples/pyg_transea.py --model transea --dataset Synthetic --alpha 0.3 --lr 0.001 --hidden 100 --features numerical_literals.npy --saved_models_path="/homes/mblum/LiteralEvaluation/saved_models" > ~/LiteralEvaluation/results/slurm_transea_synthetic_org.txt


TransEA (rand)
python -u examples/pyg_transea.py --model transea --dataset FB15k-237 --alpha 0.3 --lr 0.001 --hidden 100 --features rand --saved_models_path="/homes/mblum/LiteralEvaluation/saved_models" > ~/LiteralEvaluation/results/slurm_transea_fb15k-237_rand.txt
python -u examples/pyg_transea.py --model transea --dataset LitWD48K --alpha 0.3 --lr 0.001 --hidden 100 --features rand --saved_models_path="/homes/mblum/LiteralEvaluation/saved_models" > ~/LiteralEvaluation/results/slurm_transea_litwd48k_rand.txt
python -u examples/pyg_transea.py --model transea --dataset YAGO3-10 --alpha 0.3 --lr 0.001 --hidden 100 --features rand --saved_models_path="/homes/mblum/LiteralEvaluation/saved_models" > ~/LiteralEvaluation/results/slurm_transea_yago3-10_rand.txt
python -u examples/pyg_transea.py --model transea --dataset Synthetic --alpha 0.3 --lr 0.001 --hidden 100 --features rand --saved_models_path="/homes/mblum/LiteralEvaluation/saved_models" > ~/LiteralEvaluation/results/slurm_transea_synthetic_rand.txt
...
literal_feature_dim = FEATURE_DIMs[DATASET]
